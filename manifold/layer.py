...
class HypCLS(nn.Module): #classifier?
...
class Optimizer(object):
    def __init__(self, model, euc_optim, hyp_optim, euc_lr, hyp_lr, euc_weight_decay, hyp_weight_decay):
        # Extract optimizer types and parameters from arguments
        euc_optimizer_type = euc_optim
        hyp_optimizer_type = hyp_optim
        euc_lr = euc_lr
        hyp_lr = hyp_lr
        euc_weight_decay = euc_weight_decay
